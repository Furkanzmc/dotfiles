...
function M.setup_rest_nvim()
	...
	map("n", "<leader>tt", "<Plug>RestNvim", { silent = true, buffer = vim.api.nvim_get_current_buf() })
	map("n", "<leader>tp", "<Plug>RestNvimPreview", { silent = true, buffer = vim.api.nvim_get_current_buf() })
end
