...
function M.init()
	...
	-- URL text object.
	map("x", "iu", ":<C-u>lua require'vimrc.textobjects'.url_text_object()<CR>", { silent = true, noremap = true })
	...
	-- Number
	map("x", "in", ":<C-u>lua require'vimrc.textobjects'.number_text_object()<CR>", { silent = true, noremap = true })
