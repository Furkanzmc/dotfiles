...
function M.init_paq()
    ...
    paq{'sakhnik/nvim-gdb', opt=true, hook=fn['remote#host#UpdateRemotePlugins']}
    paq{'rust-lang/rust.vim', opt=true}
    paq{'nvim-treesitter/nvim-treesitter', opt=true}
    paq{'furkanzmc/nvim-http', opt=true, hook=fn['remote#host#UpdateRemotePlugins']}

    -- }}}
end

function M.setup_treesitter()
    if fn.exists(":TSInstall") == 1 then
        return
    end
