...
return {
    ...
    mappings = {
        ...
        {{'shift'}, 'n', 'center_narrow', true}, {{}, 'c', 'center', true},
        {{'shift'}, 'w', 'center_wide', true}, {{'shift'}, 'a', 'left', true},
        {{}, 's', 'down', true}, {{}, 'w', 'up', true},
        {{'shift'}, 'd', 'right', true}, {{}, 'a', 'left_same_size', true},
        {{}, 'd', 'right_same_size', true}, {{}, 'q', 'up_left', true},
        {{}, 'e', 'up_right', true}, {{}, 'z', 'down_left', true},
        {{}, 'x', 'down_right', true}, {{'shift'}, '-', 'stretch_height', true},
        {{}, '[', 'tile_left_half', true}, {{}, ']', 'tile_right_half', true},
        {{}, '-', 'tile_horizontal', true}, {{}, '\\', 'tile_vertical', true},
        {{}, 's', 'saveWindow', true}, {{}, 'm', 'enableMarkWindowMode', false},
