...
ToggleWindowsDefaultAppMode() {
    ...
    if appMode
    {
        Run, pwsh -NoLogo -NonInteractive -WindowStyle Hidden -Command "Set-Content -Path ~/.dotfiles/pwsh/tmp_dirs/system_theme -Value dark && Set-Terminal-Theme dark"
    }
    else
    {
        Run, pwsh -NoLogo -NonInteractive -WindowStyle Hidden -Command "Set-Content -Path ~/.dotfiles/pwsh/tmp_dirs/system_theme -Value light && Set-Terminal-Theme light"
    }
}
